  ...
  return (
    <div className='w-full h-full'>
      ...
      <div className='flex flex-col gap-4 text-typography-base dark:text-dark-typography-base p-8'>
        ...
        <h3 className='text-2xl'>Cookies de Terceiros</h3>
        ...
        <h3 className='text-2xl'>Compromisso do Usuário</h3>
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Obra Minha oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul className='flex flex-col gap-2'>
          ...
          <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Obra Minha, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        <h3 className='text-2xl'>Mais informações</h3>

...
export default function OrganizationForm({ organization_to_update, close = () => { }, getOrganizations }) {
  ...
  return (
    <section className='flex flex-col sm:w-full md:w-fit  md:h-auto sm:h-[90dvh] gap-3 justify-between md:overflow-visible sm:overflow-auto scrollbar-hide md:p-0 sm:py-5'>
